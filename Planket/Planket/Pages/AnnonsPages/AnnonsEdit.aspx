            ...
            <div class="MyMainEdit add well well-lg">
                <div class="MainEdit">
                    ...
                    <div class="editor-field">
                        <asp:TextBox class="MyEditPutIn" ID="Rubrik" runat="server" Text='<%# BindItem.Rubrik %>' MaxLength="25" />
                    ...
                    <div class="editor-field">
                        <asp:TextBox class="MyEditPutIn" ID="EditPris" runat="server" Text='<%# BindItem.Pris %>' />                
                    ...
                    <div class="editor-field">
                        <asp:TextBox class="MyEditBox MyEditPutIn" ID="EditBeskrivning" runat="server" Text='<%# BindItem.Beskrivning %>' TextMode="MultiLine" MaxLength="500" />
