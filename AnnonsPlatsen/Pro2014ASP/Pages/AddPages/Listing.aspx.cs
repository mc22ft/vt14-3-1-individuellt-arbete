...
namespace Pro2014ASP.Pages.AddPages
{
    public partial class Listing : System.Web.UI.Page
    {
        ...
        {
            //CancelHyperLink.NavigateUrl = GetRouteUrl("CustomerDetails", null);
        }


                                
        public IEnumerable<Add> AddListView_GetData() //Får ligga kvar så jag vet hur det funkade innan!!!!
        {
